...
namespace SDKTemplate
{
    ...
    public sealed partial class BlankPage1 : Page
    {
        ...
        private void app_button_Click(object sender, RoutedEventArgs e)
        {
                ...
                this.Frame.Navigate(typeof(authenticate), null);
        ...
        {
            this.Frame.Navigate(typeof(history),null);
        }

        private void accSettings_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(Acc_Settings),null);
        }

        private void change_pwd_Click(object sender, RoutedEventArgs e)
        {
            this.Frame.Navigate(typeof(change_password),null);
        }
    }
}
